...
public class ExportXmlConfigCmd extends WSManBaseCommand {
    ...
    public ExportXmlConfigCmd(String ipAddr, String userName, String passwd, String shareType, String shareName, String shareAddress, String FileName, String shareUserName, String sharePassword, String target) throws Exception {
        ...
        /*
         * if (shutdownType !=0) { session.addUserParam("ShutdownType", Integer.toString(shutdownType)); } else { session.addUserParam("ShutdownType", "0"); }
         */
