 ...
 *
 */
public class RaidDHSDiskCmd extends AbstractRaid {

    private List<KeyValuePair> keyValue = new ArrayList<KeyValuePair>();
    private static final Logger logger = LoggerFactory.getLogger(RaidDHSDiskCmd.class);


    public RaidDHSDiskCmd(String ipAddr, String userName, String passwd) {
        super(ipAddr, userName, passwd);
        // TODO Auto-generated constructor stub
        if (logger.isTraceEnabled()) {
            logger.trace(String.format("Entering constructor: RaidDHSDiskCmd(String ipAddr - %s, String userName - %s, String passwd - %s)", ipAddr, userName, "####"));
        }
        logger.trace("Exiting constructor: RaidDHSDiskCmd()");
    }
    ...
    public Object execute() throws Exception {
        ...
        session.setInvokeCommand(RaidWSManMethodEnum.GetDHSDisks.getDisplayString());
