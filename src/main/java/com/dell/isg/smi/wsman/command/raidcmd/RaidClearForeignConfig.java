 ...
 *
 */
public class RaidClearForeignConfig extends AbstractRaid {
    private List<KeyValuePair> keyValue = new ArrayList<KeyValuePair>();
    private static final Logger logger = LoggerFactory.getLogger(RaidClearForeignConfig.class);


    public RaidClearForeignConfig(String ipAddr, String userName, String passwd) {
        super(ipAddr, userName, passwd);
        // TODO Auto-generated constructor stub
        if (logger.isTraceEnabled()) {
            logger.trace(String.format("Entering constructor: RaidClearForeignConfig(String ipAddr - %s, String userName - %s, String passwd - %s)", ipAddr, userName, "####"));
        }
        logger.trace("Exiting constructor: RaidClearForeignConfig()");
    }
    ...
    public Object execute() throws Exception {
        ...
        session.setInvokeCommand(RaidWSManMethodEnum.ClearForeignConfig.getDisplayString());
