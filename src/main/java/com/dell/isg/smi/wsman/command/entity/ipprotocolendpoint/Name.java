...
@XmlType(name = "")
@XmlRootElement(name = "Name", namespace = "http://schema.omc-project.org/wbem/wscim/1/cim-schema/2/OMC_IPMIIPProtocolEndpoint")
public class Name extends CimString {
