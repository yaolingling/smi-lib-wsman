...
public class BackupImageCmd extends WSManBaseCommand {
    ...
    public BackupImageCmd(String ipAddr, String userName, String passwd, String shareType, String shareName, String shareAddress, String shareUserName, String sharePassword) throws Exception {
