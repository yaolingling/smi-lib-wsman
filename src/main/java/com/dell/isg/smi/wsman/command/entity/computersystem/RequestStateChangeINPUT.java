...
@XmlRootElement(name = "RequestStateChange_INPUT", namespace = "http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_ComputerSystem")
public class RequestStateChangeINPUT {

    @XmlElement(name = "RequestedState", namespace = "http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_ComputerSystem", required = true, nillable = true)
    protected RequestStateChangeINPUT.RequestedState requestedState;
    @XmlElement(name = "TimeoutPeriod", namespace = "http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_ComputerSystem", required = true, nillable = true)
