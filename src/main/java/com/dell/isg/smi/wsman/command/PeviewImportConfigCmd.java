...
public class PeviewImportConfigCmd extends WSManBaseCommand {

    private static final Logger logger = LoggerFactory.getLogger(PeviewImportConfigCmd.class);
    ...
    public PeviewImportConfigCmd(String ipAddr, String userName, String passwd, String shareType, String shareName, String shareAddress, String FileName, String shareUserName, String sharePassword) throws Exception {
        ...
        this.session.setInvokeCommand(WSManMethodEnum.PREVIEW_IMPORT_SYSTEM_CONFIGURATION.toString());
    ...
    public XmlConfig execute() throws Exception {
        ...
        logger.info("Entering execute(), Preview import configuration for server {} ", session.getIpAddress());
