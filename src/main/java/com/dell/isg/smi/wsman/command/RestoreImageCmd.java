...
public class RestoreImageCmd extends WSManBaseCommand {
    ...
    public RestoreImageCmd(String ipAddr, String userName, String passwd, String shareType, String shareName, String shareAddress, String shareUserName, String sharePassword) throws Exception {
       ...
       // ImageName
        //PreserveVDConfig
       // ScheduledStartTime - Start time for the job execution in format: yyyymmddhhmmss.The string "TIME_NOW" means immediate
      //  UntilTime - End time for the job execution in format: yyyymmddhhmmss. :If this parameter is not NULL, then ScheduledStartTime parameter shall also be specified.
