 ...
 *
 */
public class GetIDracEnumAttributes extends AbstractIdrac {
     ...
     * @param passwd
     */
    public GetIDracEnumAttributes(String ipAddr, String userName, String passwd) {

        super(ipAddr, userName, passwd);
        if (logger.isTraceEnabled()) {
            logger.trace(String.format("Entering constructor: GetIDracEnumAttributes(String ipAddr - %s, String userName - %s, String passwd - %s)", ipAddr, userName, "####"));
        }
    ...
    private String getResourceURI() {
        ...
        sb.append(WSManClassEnum.DCIM_iDRACCardEnumeration);// "DCIM_iDRACCardEnumeration");
        return sb.toString();
    }
