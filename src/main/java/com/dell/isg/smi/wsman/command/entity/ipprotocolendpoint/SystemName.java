...
@XmlType(name = "")
@XmlRootElement(name = "SystemName", namespace = "http://schema.omc-project.org/wbem/wscim/1/cim-schema/2/OMC_IPMIIPProtocolEndpoint")
public class SystemName extends CimString {
