 ...
 *
 */
public class InbandWSManClient extends DefaultWSManClient implements IWSManClient {

    final String wsManLoggingEnabled = "false";
    private static final Logger logger = LoggerFactory.getLogger(InbandWSManClient.class);
     ...
     * @param password
     */
    InbandWSManClient(String ip, String username, String password) {
        super(ip, username, password);

    }


    InbandWSManClient(String ip, int port, String username, String password) {
        super(ip, port, username, password);
    }


    InbandWSManClient(URL destination, String username, String password) {
