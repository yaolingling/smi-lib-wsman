 ...
 *         &lt;element name="CollectionElementName" type="{http://schemas.dmtf.org/wbem/wscim/1/common}cimString"/>
...
@XmlType(name = "", propOrder = { "targetBIOS", "collectionElementName", "attributeName", "attributeValue", "authorizationToken", "passwordEncoding" })
@XmlRootElement(name = "SetBIOSAttributes_INPUT")
public class SetBIOSAttributesINPUT {

    @XmlElement(name = "TargetBIOS", required = true, nillable = true)
    protected CimReference targetBIOS;
    @XmlElement(name = "CollectionElementName", required = true, nillable = true)
    protected CimString collectionElementName;
    ...
    protected SetBIOSAttributesINPUT.PasswordEncoding passwordEncoding;
    ...
    /**
     * Gets the value of the collectionElementName property.
     * 
     * @return possible object is {@link CimString }
     * 
     */
    public CimString getCollectionElementName() {
        return collectionElementName;
    }


    /**
     * Sets the value of the collectionElementName property.
     * 
     * @param value allowed object is {@link CimString }
     * 
     */
    public void setCollectionElementName(CimString value) {
        this.collectionElementName = value;
    }
     ...
     * 
     * @return possible object is {@link SetBIOSAttributesINPUT.PasswordEncoding }
     * 
     */
    public SetBIOSAttributesINPUT.PasswordEncoding getPasswordEncoding() {
     ...
     * 
     * @param value allowed object is {@link SetBIOSAttributesINPUT.PasswordEncoding }
     * 
     */
    public void setPasswordEncoding(SetBIOSAttributesINPUT.PasswordEncoding value) {
