 ...
 *
 */
public class GetIDracStringAttributes extends AbstractIdrac {
     ...
     * @param passwd
     */
    public GetIDracStringAttributes(String ipAddr, String userName, String passwd) {

        super(ipAddr, userName, passwd);
        if (logger.isTraceEnabled()) {
            logger.trace(String.format("Entering constructor: GetIDracStringAttributes(String ipAddr - %s, String userName - %s, String passwd - %s)", ipAddr, userName, "####"));
        }
